...
@section('content')
    <div class="mainContent">
        <section>
            <h1>település neve</h1>
            <img src="https://placehold.co/600x400" alt="szalloda_kep_0" title="Szálloda" class="szallodaMainImg img-fluid">
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem nemo consequuntur perferendis ducimus
                quam
                autem
                suscipit atque sit laudantium, ea harum delectus, cum cupiditate quos nihil. Atque cupiditate odit
                ullam.
            </p>
        </section>
        <div class="citySection">
            <div class="city">
                ...
                <div class="cityImgContainer">
                    ...
                    <p><span class="starTicked">★★★★★</span></p>
                </div>
                <p style="float: none;">
            ...
            <div class="city">
                ...
                <div class="cityImgContainer">
                    <img src="https://placehold.co/400" alt="telepules" title="Település" class="img-fluid">
                    <p><span class="starTicked">★★★</span><span class="starUnTicked">★★</span></p>
                </div>
                <p style="float: none;">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus vehicula varius magna. Praesent
                    consequat, eros vel iaculis efficitur, ante odio rutrum ex, eget finibus elit justo nec orci.
